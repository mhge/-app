<template>
  <div class="Out">
    <section>
      <van-nav-bar title="登录" left-arrow @click-left="onClickLeft"></van-nav-bar>
      <div class="tx">
        <img src="https://i03picsos.sogoucdn.com/fd6f8c1f1dc350cd" alt>
      </div>
      <div class="Info">
        <van-row type="flex" class="DID">
          ...
          <van-field
            ...
            @click-right-icon="$toast('仅支持 132 | 150 | 152 开头的手机号')"
            @keyup.13="onClickLogin()"
          />
        </van-row>
