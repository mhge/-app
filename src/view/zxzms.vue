<template>
  <div>
    ...
    <van-tabbar v-model="active" :fixed="false" active-color="black" inactive-color="#A9A9A9" class="tab">
      <van-tabbar-item to="/zxzm">
        <span>最新招募</span>
      </van-tabbar-item>
      <van-tabbar-item to="/tczy">
        <span>同城志愿</span>
      </van-tabbar-item>
      <van-tabbar-item to="/xszm">
      <span>线上招募</span>
      </van-tabbar-item>
    </van-tabbar>
