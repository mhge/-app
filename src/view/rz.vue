...
营利性组织。"/>
          ...
          <van-row>
            ...
            <van-col span="24" class="flex">
              ...
              <div>
                <h4>注册您的志愿组织</h4>
                <p>
                  打开电脑,访问https:v.17weishan.com注册账用于创建及管理您
                  的志愿组织。
                </p>
              </div>
            </van-col>
    ...
    <van-row class="color">
      <van-col span="20" offset="1">
        <div>
          <h4>作作为志愿组织的创建者,我有什么样的权利义务?</h4>
          <p>1、可以招募更多的小伙伴一起参与公益活动。</p>
          <p>2、审核:确保小伙伴们不犯错。</p>
          <p>3、信息的正确性:保证发布的信息是合规的。</p>
        </div>
      </van-col>
    </van-row>
  </div>
